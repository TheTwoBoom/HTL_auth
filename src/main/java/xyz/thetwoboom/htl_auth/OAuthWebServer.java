    ...
    public Response serve(IHTTPSession session) {
        if ("/auth".equals(session.getUri())) {
            ...
            try {
                ...
                return newFixedLengthResponse(Response.Status.OK, "text/plain", "Success. Please close this window and return to the game.");

            } catch (IllegalArgumentException e) {
                return newFixedLengthResponse(Response.Status.BAD_REQUEST, "text/plain", "Invalid UUID.");
            }
        }
